...
import cn.edu.hnie.common.utils.SpringContextUtils;
...
public abstract class AbstractExcelResolver implements CellValueConverter{
	...
	private CellValueConverter getBean(String convName) throws ClassNotFoundException {
		...
		if(SpringContextUtils.isInited()){
			bean = (CellValueConverter) SpringContextUtils.getBean(Class.forName(convName));
		}else{
