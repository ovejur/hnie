## 平台简介
rg快速开发平台是基于多个优秀的开源项目，将各个亮点设计融于一体的快速开发平台。平台内置 用户管理、部门管理、角色管理、菜单管理、日志管理、数据源监控、定时任务 等功能。
...
## 如何交流、反馈、参与贡献？
- Git仓库：https://gitee.com/theodo/rg
- QQ交流群：583154815
...
- Eclipse运行rg-system工程rgSystemApplication.java，则可启动项目
- 项目访问路径：http://localhost:8080/rg
- 账号密码：admin/123456
